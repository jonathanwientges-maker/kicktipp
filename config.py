...
KICKTIPP_TEAM_ALIASES = {
    ...
    # Further clubs seen on the buli-challenge form / in fixtures.csv --
    # promoted sides (Schalke are back in the 2026/27 Bundesliga) and
    # names that turn up when the pool spans a wider set of teams.
    # football-data.co.uk name on the right; identity where FD uses the
    # bare name. An unmapped name still hard-fails, so list them here.
    "Schalke": "Schalke 04",
